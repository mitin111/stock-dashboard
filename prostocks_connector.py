...
# ----------------------------------------------------
    # WebSocket: Subscribe to a list of symbols
    # ----------------------------------------------------
...
def on_open(ws):
    ...
    # abhi yaha se har token subscribe hoga
    try:
