...
def subscribe_tokens(self, tokens):
    """Subscribe to WS tokens (EXCH|TOKEN)"""
...
def start_ticks(self, symbols, tick_file="ticks.log"):
    ...
    import threading, time, websocket, json
